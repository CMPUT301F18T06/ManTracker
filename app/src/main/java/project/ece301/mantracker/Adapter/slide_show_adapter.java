...
public class slide_show_adapter extends RecyclerView.Adapter<slide_show_adapter.ViewHolder> {
    ...
    private ArrayList<String> img_cell_lsit;
    private Context context;

    public  slide_show_adapter(Context context , ArrayList<String> img_cell_list){
...
//        viewholder.title.setText(img_cell_lsit.get(i).getTitle());
        ...
        viewholder.img.setImageBitmap(  Decode(img_cell_lsit.get(i)) );
